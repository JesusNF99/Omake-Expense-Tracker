...
const Register = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Optional: automatically log them in or alert success
    ...
    <div className="min-h-screen bg-[#0c0e12] flex flex-col items-center justify-center p-4 font-sans">
      ...
      <div className="w-full max-w-md bg-[#1d2025] rounded-2xl p-8 shadow-[0_20px_40px_rgba(6,182,212,0.15)] border-t border-l border-[#c284ff]/20">
        <div className="text-center mb-8">
          <h2 className="text-2xl text-white font-space-grotesk font-bold tracking-tight">Register</h2>
        </div>
        ...
        {success && (
          <div className="mb-6 p-4 rounded-md bg-[#00687a]/20 border border-[#06b6d4]/30 flex items-center text-[#06b6d4]">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <button 
            type="submit" 
            className="w-full py-3 px-4 rounded-md font-medium text-white bg-gradient-to-br from-[#06b6d4] to-[#a855f7] hover:shadow-[0_0_15px_rgba(6,182,212,0.4)] transition-all duration-300"
          >
            Register
          </button>
        </form>
        ...
        <p className="mt-8 text-center text-sm text-[#9ca3af]">
          Already have an account? <Link to="/login" className="text-[#06b6d4] hover:text-[#53ddfc] font-medium transition-colors">Log in</Link>
        </p>
      </div>
    </div>
  );
